...
function excluirFavorito(obj){
    var id_item = $(obj).attr("data-idItem");
    $(obj).closest("#removeFavorito").remove();
    $.ajax({
        url: base_url + "noticias/excluir-galeria.php",
        type: "POST",
...
function excluirSecretarias(obj){
    var id_item = $(obj).attr("data-idItem");
    $(obj).closest("#removeFavorito").remove();
    $.ajax({
        url: base_url + "secretarias/excluir-galeria.php",
        type: "POST",
        data:{id_item: id_item},
        dataType: "json",
        success: function(){
...
function excluirSubSecretarias(obj){
    var id_item = $(obj).attr("data-idItem");
    $(obj).closest("#removeFavorito").remove();
    $.ajax({
        url: base_url + "subsecretarias/excluir-galeria.php",
        type: "POST",
        data:{id_item: id_item},
        dataType: "json",
        success: function(){
...
function excluirNoticiasSecretarias(obj){
    var id_item = $(obj).attr("data-idItem");
    $(obj).closest("#removeFavorito").remove();
    $.ajax({
        url: base_url + "noticias-secretarias/excluir-galeria.php",
        type: "POST",
        data:{id_item: id_item},
        dataType: "json",
        success: function(){
...
function excluirNoticiasSubSecretarias(obj){
    var id_item = $(obj).attr("data-idItem");
    $(obj).closest("#removeFavorito").remove();
    $.ajax({
        url: base_url + "noticias-subsecretarias/excluir-galeria.php",
        type: "POST",
        data:{id_item: id_item},
        dataType: "json",
        success: function(){
...
function excluirServicosSecretarias(obj){
    var id_item = $(obj).attr("data-idItem");
    $(obj).closest("#removeFavorito").remove();
    $.ajax({
        url: base_url + "servicos-secretarias/excluir-galeria.php",
        type: "POST",
        data:{id_item: id_item},
        dataType: "json",
        success: function(){
...
function excluirServicosSubSecretarias(obj){
    var id_item = $(obj).attr("data-idItem");
    $(obj).closest("#removeFavorito").remove();
    $.ajax({
        url: base_url + "servicos-subsecretarias/excluir-galeria.php",
        type: "POST",
        data:{id_item: id_item},
        dataType: "json",
        success: function(){
...
function excluirSetoresSecretarias(obj){
    var id_item = $(obj).attr("data-idItem");
    $(obj).closest("#removeFavorito").remove();
    $.ajax({
        url: base_url + "setores-secretarias/excluir-galeria.php",
        type: "POST",
        data:{id_item: id_item},
        dataType: "json",
        success: function(){
...
function excluirSetoresSubSecretarias(obj){
    var id_item = $(obj).attr("data-idItem");
    $(obj).closest("#removeFavorito").remove();
    $.ajax({
        url: base_url + "setores-subsecretarias/excluir-galeria.php",
        type: "POST",
        data:{id_item: id_item},
        dataType: "json",
        success: function(){
...
function excluirProjetosSecretarias(obj){
    var id_item = $(obj).attr("data-idItem");
    $(obj).closest("#removeFavorito").remove();
    $.ajax({
        url: base_url + "projetos-secretarias/excluir-galeria.php",
        type: "POST",
        data:{id_item: id_item},
        dataType: "json",
        success: function(){
...
function excluirGaleriasSecretarias(obj){
    var id_item = $(obj).attr("data-idItem");
    $(obj).closest("#removeFavorito").remove();
    $.ajax({
        url: base_url + "galerias-secretarias/excluir-galeria.php",
        type: "POST",
        data:{id_item: id_item},
        dataType: "json",
        success: function(){
...
function excluirGaleriasSubSecretarias(obj){
    var id_item = $(obj).attr("data-idItem");
    $(obj).closest("#removeFavorito").remove();
    $.ajax({
        url: base_url + "galerias-subsecretarias/excluir-galeria.php",
        type: "POST",
        data:{id_item: id_item},
        dataType: "json",
        success: function(){
...
function excluirGaleriasConselhos(obj){
    var id_item = $(obj).attr("data-idItem");
    $(obj).closest("#removeFavorito").remove();
    $.ajax({
        url: base_url + "conselhos/excluir-galeria.php",
        type: "POST",
        data:{id_item: id_item},
        dataType: "json",
        success: function(){
...
function excluirGaleriasConselhosNoticias(obj){
    var id_item = $(obj).attr("data-idItem");
    $(obj).closest("#removeFavorito").remove();
    $.ajax({
        url: base_url + "noticias-conselhos/excluir-galeria.php",
        type: "POST",
        data:{id_item: id_item},
        dataType: "json",
        success: function(){
...
function excluirGaleriasConselhosServicos(obj){
    var id_item = $(obj).attr("data-idItem");
    $(obj).closest("#removeFavorito").remove();
    $.ajax({
        url: base_url + "servicos-conselhos/excluir-galeria.php",
        type: "POST",
        data:{id_item: id_item},
        dataType: "json",
        success: function(){
...
function excluirGaleriasConselhosSetores(obj){
    var id_item = $(obj).attr("data-idItem");
    $(obj).closest("#removeFavorito").remove();
    $.ajax({
        url: base_url + "setores-conselhos/excluir-galeria.php",
        type: "POST",
        data:{id_item: id_item},
        dataType: "json",
        success: function(){
...
function excluirGaleriasConselhosProjetos(obj){
    var id_item = $(obj).attr("data-idItem");
    $(obj).closest("#removeFavorito").remove();
    $.ajax({
        url: base_url + "projetos-conselhos/excluir-galeria.php",
        type: "POST",
        data:{id_item: id_item},
        dataType: "json",
        success: function(){
...
function excluirGaleriasConselhosGb(obj){
    var id_item = $(obj).attr("data-idItem");
    $(obj).closest("#removeFavorito").remove();
    $.ajax({
        url: base_url + "galerias-conselhos/excluir-galeria.php",
        type: "POST",
        data:{id_item: id_item},
        dataType: "json",
        success: function(){
...
function excluirGaleriasGaginetePrefeito(obj){
    var id_item = $(obj).attr("data-idItem");
    $(obj).closest("#removeFavorito").remove();
    $.ajax({
        url: base_url + "gabinete-prefeito/excluir-galeria.php",
        type: "POST",
        data:{id_item: id_item},
        dataType: "json",
        success: function(){
...
function excluirGaleriasGaginetePrefeitoNoticias(obj){
    var id_item = $(obj).attr("data-idItem");
    $(obj).closest("#removeFavorito").remove();
    $.ajax({
        url: base_url + "noticias-gabinete-prefeito/excluir-galeria.php",
        type: "POST",
        data:{id_item: id_item},
        dataType: "json",
        success: function(){
...
function excluirGaleriasGaginetePrefeitoSetores(obj){
    var id_item = $(obj).attr("data-idItem");
    $(obj).closest("#removeFavorito").remove();
    $.ajax({
        url: base_url + "setores-gabinete-prefeito/excluir-galeria.php",
        type: "POST",
        data:{id_item: id_item},
        dataType: "json",
        success: function(){
...
function excluirGaleriasTurismo(obj){
    var id_item = $(obj).attr("data-idItem");
    $(obj).closest("#removeFavorito").remove();
    $.ajax({
        url: base_url + "turismo/excluir-galeria.php",
        type: "POST",
        data:{id_item: id_item},
        dataType: "json",
        success: function(){
...
function excluirGaleriasPaginas(obj){
    var id_item = $(obj).attr("data-idItem");
    $(obj).closest("#removeFavorito").remove();
    $.ajax({
        url: base_url + "paginas/excluir-galeria.php",
        type: "POST",
        data:{id_item: id_item},
        dataType: "json",
        success: function(){
